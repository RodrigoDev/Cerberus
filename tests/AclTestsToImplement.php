...
class AclTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCMSExample()
    {
        ...
        $this->_acl->addRole(new Role\GenericRole('guest'))
                   ->addRole(new Role\GenericRole('staff'), 'guest')  // staff inherits operations from guest
                   ->addRole(new Role\GenericRole('editor'), 'staff') // editor inherits operations from staff
        ...
        // Access control checks based on above operation sets
        ...
        // Add a new group, marketing, which bases its operations on staff
        ...
        // Access control checks for the above refined operation sets
        ...
        // Remove some previous operation specifications
        ...
        // Grant marketing all operations on the latest news
